...
namespace App\Modules\api\V1\Home\Providers;

use Illuminate\Support\Facades\Route;
use Illuminate\Support\ServiceProvider;

class APIHomeServiceProvider extends ServiceProvider
{
    protected $namespace = 'App\Modules\api\V1\Home\Http\Controllers';
