(function($) {
    $(document).ready(function() {
        ...
        $(document).on('click', '#promotion_close', function(event) {
            ...
            $.get('frontend/close-promotion.html', function(data) {
        ...
        $(document).on('submit', '#subscriptionForm', function(event) {
            ...
            formData.append('_token', "tW3d9kIg46N8C3388j7rbEM4f6NWVGwGrgFxQP8i");
            $('.message_div').html('');
            $('.message_div').addClass('d-none');
            $.ajax({
                url: "https://amazy.rishfa.com/subscription/store",
                type: "POST",
                cache: false,
                contentType: false,
                processData: false,
        ...
        $(document).on('click', '.load_more_btn_homepage', function(event) {
            event.preventDefault();
            Cpage++;
            var new_url = 'get-more-productsa54e.html?page=';
        ...
        $(document).on('submit', '#search_form', function(event) {
            ...
            var genUrl = "https://amazy.rishfa.com/category" + '/' + input_data + '?item=search&category=' + $('.category_id option:selected').val();
                ...
                `);
                        ...
                        <a data-type="product" href="${item.url}" class="store_link product_search_single d-flex align-items-center mb_10 gap_10">
                            <div class="product_info d-flex align-items-center flex-fill gap_10">
                                <div class="thumb">
                                        <img data-src="${item.thumb_img}" alt="" src="https://amazy.rishfa.com/public/frontend/amazy/img/default_img.jpg" class="lazyload">
                                </div>
                    ...
                    `);
                            ...
                            <a href="${url}" data-type="product" class="store_link product_search_single d-flex align-items-center gap_10">
                                <div class="product_info flex-fill d-flex gap_10 mb_10 align-items-center">
                                    <div class="thumb">
                                        <img data-src="${item.avater}" alt="" src="https://amazy.rishfa.com/public/frontend/amazy/img/default_img.jpg" class=lazyload>
                                    </div>
                                    <div class="product_info_text">
